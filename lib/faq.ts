...
export const FAQ: readonly FaqEntry[] = [
  {
    ...
    answer:
      "Ο κώδικας και το repository είναι δικά σας από την πρώτη μέρα, και η εγκατάσταση παραδίδεται τεκμηριωμένη. Οποιοσδήποτε developer μπορεί να ανοίξει το έργο και να συνεχίσει χωρίς εμάς. Δεν υπάρχει κλείδωμα σε πλατφόρμα, σε λογαριασμό ή σε πρόσωπο.",
  },
  {
    id: "pricing",
