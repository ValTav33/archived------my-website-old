  ...
  return (
    <PageShell>
      ...
      <ServiceSection
        ...
        lede={`Δεν χρεώνουμε με την ώρα. Συμφωνούμε τι μπαίνει και τι δεν μπαίνει, βγαίνει μία τιμή, και αυτή είναι η τιμή — ακόμα και αν η δουλειά μας πάρει περισσότερο από όσο υπολογίσαμε. Ο χρόνος παράδοσης είναι ${TIMELINE_RANGE}.`}
      >
      ...
      <ServiceSection
        id="drivers"
        eyebrow="ΤΙ ΜΕΤΑΚΙΝΕΙ ΤΟ ΝΟΥΜΕΡΟ"
      ...
      <ServiceSection
        id="numbers"
        eyebrow="ΓΙΑΤΙ ΔΕΝ ΒΛΕΠΕΤΕ ΤΙΜΕΣ ΕΔΩ"
        title="Ακόμα."
