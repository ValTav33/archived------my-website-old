  ...
  return (
    <PageShell>
      <SectionHeader
        ...
        lede={`Τρία βήματα. Σε κάθε ένα ξέρετε τι γίνεται, τι χρειάζεται από εσάς, τι παίρνετε στο τέλος του, και πόσο από τον χρόνο σας κοστίζει. Ο συνολικός χρόνος είναι ${TIMELINE_RANGE} — εύρος, όχι υπόσχεση.`}
      />
