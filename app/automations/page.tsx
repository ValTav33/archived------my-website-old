    ...
    <>
      ...
      <PageShell>
        ...
        <ServiceSection
          ...
          lede={`Ξεκινάμε με ένα δωρεάν audit — παίρνετε ${AUDIT_DELIVERABLE}. Μετά συμφωνούμε ποια διαδικασία αυτοματοποιείται πρώτη, και η κατασκευή παραδίδεται σε στάδια. Ο χρόνος είναι ${TIMELINE_RANGE} — εύρος, όχι υπόσχεση.`}
        >
        ...
        <ServiceSection
          ...
          lede="Σε λογαριασμούς δικούς σας — n8n, Supabase, το email σας, το CRM σας. Τα κλειδιά και τα δεδομένα μένουν εκεί, και δεν περνούν από κάποια πλατφόρμα δική μας. Αν σταματήσουμε να συνεργαζόμαστε, οι ροές συνεχίζουν να τρέχουν."
        >
