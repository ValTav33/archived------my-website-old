...
const SECTIONS: readonly LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Τι παραδίδεται σε κάθε έργο, σε ποιον ανήκει και ποιος διαχειρίζεται τους λογαριασμούς όπου ζει, συμφωνούνται γραπτά ανά έργο και πριν ξεκινήσει η δουλειά. Τα πακέτα διαφέρουν, οπότε δεν υπάρχει ένας κανόνας που να ισχύει για όλα — υπάρχει όμως πάντα γραπτή απάντηση, και τη βλέπετε πριν συμφωνήσετε.",
